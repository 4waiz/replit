...
import { palette, RiskLevel, riskColor } from '@/constants/colors';
...
// Circular risk gauge built from two rotating half-rings — no SVG dependency.
// Fills proportionally to `score` and animates on mount.
export function RiskGauge({ score, level, size = 200 }: RiskGaugeProps) {
  ...
  // First half (0-180°) and second half (180-360°) rotate independently.
  ...
  return (
    <View style={{ width: size, height: size, alignItems: 'center', justifyContent: 'center' }}>
      ...
      <View
        style={[
          styles.ring,
          { width: size, height: size, borderRadius: half, borderWidth: stroke, borderColor: 'rgba(255,255,255,0.07)' },
        ]}
      />
...
const styles = StyleSheet.create({
  ...
  halfRing: { position: 'absolute', top: 0, borderColor: palette.primary },
